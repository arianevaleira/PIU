...
const personagens = [
  {
    ...
    nome: "Gumball",
    imagem: gumball,
    descricao: "Personagem principal do Incrível Mundo de Gumball"
  },
  {
    id: 2,
    nome: "Escudo de Hogwarts",
    imagem: escudo,
    descricao: "Símbolo da escola de magia e bruxaria de Hogwarts"
  },
  {
    id: 3,
    nome: "Hermione Granger",
    imagem: hermione,
    descricao: "Uma das protagonistas da série Harry Potter"
  },
  {
    id: 4,
    nome: "Estação Espacial",
    imagem: estacao,
    descricao: "Representação de uma estação espacial futurista"
  },
  {
    id: 5,
    nome: "Turma do Gumball",
    imagem: turma,
    descricao: "Grupo de amigos do Incrível Mundo de Gumball"
  },
  {
    id: 6,
    nome: "Gumball e Darwin",
    imagem: gumball1,
    descricao: "Gumball e seu irmão adotivo Darwin"
  }
];
